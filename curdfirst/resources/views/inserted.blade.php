...
<body class="flex items-center justify-center min-h-screen bg-gray-100">
    <div class="bg-white p-6 rounded-lg shadow-lg w-96">
        ...
        <hr class="mb-4">
        <form action="{{route('posted2')}}" method="post" class="space-y-4"> 
            @csrf
            <div>
            ...
            <div>
                ...
                <input type="text" name="email" class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
            <div>
